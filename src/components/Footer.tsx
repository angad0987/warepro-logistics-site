...
const socialLinks = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/corewarehousing?igsi=a3Y4dmgzNjVzOHp0",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/core-warehousing",
      ...
      <div className="border-t border-white/10">
        <div className="container-x py-6 flex flex-col md:flex-row gap-3 items-center justify-between text-xs text-white/55">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/privacy-policy"
              className="rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs font-medium text-white/60 hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
