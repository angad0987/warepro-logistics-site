...
export const industries: IndustryItem[] = [
  {
    ...
    bullets: [
      ...
      "Same-day dispatch",
      "Branded unboxing options",
      "Returns handling",
      "Peak-season scaling",
    ],
    image:
      "https://images.unsplash.com/photo-1607083206869-4c7672e72a8a?w=1200&auto=format&fit=crop",
  },
  {
    icon: "Store",
    title: "Retail",
    ...
    bullets: [
      ...
      "Retailer compliance labels",
      "Damaged stock handling",
      "Planogram-ready kitting",
  ...
  },
  {
    ...
    bullets: [
      "Hanging & folded storage",
      "Size/color matrix pick",
      "Tagging & labelling",
      "Returns QC & restock",
      "Seasonal ramp-up",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Bulk B2B fulfillment",
      "Pallet & carton dispatch",
  ...
  },
  {
    ...
    bullets: [
      "High-SKU parts storage",
      "Dealer network dispatch",
      "Aftermarket lanes",
      "Serialized tracking",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1583912267550-d6c2ac3196c0?w=1200&auto=format&fit=crop",
  },
];
