...
export const whyChooseUs: WhyChooseUsItem[] = [
  ...
  { id: "tech", icon: "Cpu", microLabel: "TECH", title: "Technology Driven", bullets: ["WMS + integrations", "Digital order flow"] },
  { id: "speed", icon: "Zap", microLabel: "SPEED", title: "Faster Fulfillment", bullets: ["Same-day dispatch", "Optimized pick-pack"] },
