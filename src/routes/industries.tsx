      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 gradient-dark text-white overflow-hidden">
        ...
        <div className="container-x relative">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-3xl">
            <span className="text-xs font-semibold tracking-widest uppercase text-primary">{industriesPage.heroEyebrow}</span>
            <h1 className="mt-3 text-4xl md:text-6xl font-bold tracking-tight font-heading">{industriesPage.heroHeadline}</h1>
      ...
      <section className="py-20 md:py-28 bg-secondary/40">
        <div className="container-x">
          <Reveal className="text-center max-w-4xl mx-auto">
            <span className="text-xs font-semibold tracking-widest uppercase text-primary">{industriesPage.logoSectionEyebrow}</span>
            <h2 className="mt-3 text-3xl md:text-5xl font-bold text-navy font-heading">{industriesPage.logoSectionHeadline}</h2>
            <p className="mt-3 text-muted-foreground text-lg">{industriesPage.logoSectionSubheadline}</p>
          </Reveal>
          <Reveal className="mt-12">
            <img src={industriesLogo} alt="Industries we serve" className="w-full max-w-5xl mx-auto object-contain" />
          </Reveal>
