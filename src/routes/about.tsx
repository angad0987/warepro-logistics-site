  ...
  head: () => ({
    meta: [
      { title: "About CoreWarehousing — Our Vision, Mission & Story" },
      {
        name: "description",
        content:
          "Learn about CoreWarehousing — our vision, mission and story of building a modern B2B warehousing and 3PL fulfillment partner.",
      },
      ...
      <section className="pb-24 md:pb-32">
        <div className="container-x grid lg:grid-cols-2 gap-14 items-center">
          ...
          <Reveal delay={0.1}>
            ...
            <h2 className="mt-6 text-3xl md:text-4xl font-bold text-navy font-heading">
              {story.title}
            </h2>
